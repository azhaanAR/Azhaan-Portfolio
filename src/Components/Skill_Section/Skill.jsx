...
import '../Skill_Section/Skill.css'
                ...
                <div className="row mt-5">
                    <div className="col-12">
                        <div className="my-skills">
                            <div className="track d-flex text-center">

                                <div className="skill mt-3">
                                    <span>
                                        <LazyLoad>
                                        <svg width="70" height="90" viewBox="0 0 256 290" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M255.11 0L231.868 260.36L127.399 289.322L23.2165 260.401L0 0H255.11Z" fill="#E44D26" />
                                            <path d="M127.555 267.184L211.971 243.78L231.832 21.291H127.555V267.184Z" fill="#F16529" />
                                            <path d="M82.3759 85.1659H127.556V53.2285H47.4727L48.2371 61.7968L56.0866 149.807H127.556V117.87H85.2945L82.3759 85.1659Z" fill="#EBEBEB" />
                                            <path d="M89.5735 165.776H57.5137L61.988 215.922L127.409 234.083L127.556 234.043V200.815L127.416 200.852L91.8472 191.248L89.5735 165.776Z" fill="#EBEBEB" />
                                            ...
                                            <path d="M127.445 85.0879V85.1659H204.589L205.229 77.9874L206.684 61.7968L207.448 53.2285H127.445V85.0879Z" fill="white" />
                                        </svg>
                                        </LazyLoad>
                                    </span>
                                    <h6 className=' text-white text-center'>HTML</h6>
                                </div>

                                <div className="skill mt-3">
                                    <span>
                                        <LazyLoad>
                                        <svg width="70" height="90" viewBox="0 0 112 249" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M61.2247 248.567L54.6167 246.309C54.6167 246.309 55.4234 212.624 43.3353 210.206C35.2765 200.858 44.6246 -186.289 73.6356 208.917C73.6356 208.917 63.6436 213.913 61.8702 222.456C59.9354 230.837 61.2247 248.567 61.2247 248.567Z" fill="white" />
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M61.2247 248.567L54.6167 246.309C54.6167 246.309 55.4234 212.624 43.3353 210.206C35.2765 200.858 44.6246 -186.289 73.6356 208.917C73.6356 208.917 63.6436 213.913 61.8702 222.456C59.9354 230.837 61.2247 248.567 61.2247 248.567Z" fill="#A6A385" />
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M64.7701 216.01C64.7701 216.01 122.632 177.972 109.093 98.8333C96.0386 41.2939 65.2527 22.4363 61.8687 15.1828C58.1621 10.0254 54.6152 1 54.6152 1L57.0341 161.048C57.0341 161.209 52.0365 210.046 64.7701 216.01Z" fill="white" />
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M64.7701 216.01C64.7701 216.01 122.632 177.972 109.093 98.8333C96.0386 41.2939 65.2527 22.4363 61.8687 15.1828C58.1621 10.0254 54.6152 1 54.6152 1L57.0341 161.048C57.0341 161.209 52.0365 210.046 64.7701 216.01Z" fill="#499D4A" />
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M51.2308 218.105C51.2308 218.105 -3.08606 181.034 0.138055 115.759C3.1993 50.4815 41.5599 18.4078 48.9733 12.605C53.8094 7.44761 53.9708 5.51284 54.2935 0.355469C57.6775 7.60897 57.0336 108.828 57.5161 120.755C58.9668 166.69 54.9374 209.403 51.2308 218.105Z" fill="white" />
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M51.2308 218.105C51.2308 218.105 -3.08606 181.034 0.138055 115.759C3.1993 50.4815 41.5599 18.4078 48.9733 12.605C53.8094 7.44761 53.9708 5.51284 54.2935 0.355469C57.6775 7.60897 57.0336 108.828 57.5161 120.755C58.9668 166.69 54.9374 209.403 51.2308 218.105Z" fill="#58AA50" />
                                        </svg>
                                        </LazyLoad>
                                    </span>
                                    <h6 className=' text-white text-center'>MONGODB</h6>
                                </div>
                                ...
                                <div className="skill mt-3">
                                    <span>
                                        ...
                                        <svg width="70" height="90" viewBox="0 0 256 290" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <g clip-path="url(#clip0)">
                                                <path d="M127.844 289.088L23.6618 260.166L0.445312 -0.234375H255.555L232.314 260.125L127.844 289.088Z" fill="#264DE4" />
                                                <path d="M212.417 243.547L232.278 21.0576H128V266.951L212.417 243.547Z" fill="#2965F1" />
                                                <path d="M53.668 117.636L56.5304 149.572H127.999V117.636H53.668Z" fill="#EBEBEB" />
                                                <path d="M47.918 52.9951L50.8212 84.9325H128.001V52.9951H47.918Z" fill="#EBEBEB" />
                                                <path d="M128.001 200.58L127.861 200.618L92.2925 191.013L90.0188 165.542H57.959L62.4334 215.688L127.854 233.849L128.001 233.808V200.58Z" fill="#EBEBEB" />
                                                <path d="M202.128 117.637L207.893 52.9951H127.891V84.9325H172.893L169.987 117.637H127.891V149.573H167.218L163.51 190.993L127.891 200.607V233.834L193.363 215.688L193.844 210.292L201.349 126.213L202.128 117.637Z" fill="white" />
                                            </g>
                                            <defs>
                                                <clipPath id="clip0">
                                    ...
                                    <h6 className=' text-white text-center'>JAVA SCRIPT</h6>
                                </div>

                                <div className="skill mt-3">
                                    <span>
                                        <LazyLoad>
                                        <svg width="70" height="90" viewBox="0 0 256 228" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <h6 className=' text-white text-center'>REACT</h6>
                                </div>

                                <div className="skill mt-3">
                                    <span>
                                        <LazyLoad>
                                        <svg width="70" height="90" viewBox="0 0 256 256" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <g clip-path="url(#clip0)">
                                    ...
                                    <h6 className=' text-white text-center'>GIT</h6>
                                </div>
                                ...
                                <div className="skill mt-3">
                                    <span>
                                        <LazyLoad>
                                        <svg width="70" height="90" viewBox="0 0 256 256" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M0 222.991C0 241.223 14.7785 256 33.0088 256H222.991C241.223 256 256 241.221 256 222.991V33.0088C256 14.7765 241.221 0 222.991 0H33.0088C14.7765 0 0 14.7785 0 33.0088V222.991Z" fill="#563D7C" />
                                            <path d="M106.157 113.238V76.9846H138.069C141.108 76.9846 144.038 77.2379 146.861 77.7444C149.683 78.2509 152.179 79.1555 154.35 80.458C156.521 81.7605 158.258 83.5695 159.56 85.8852C160.863 88.2008 161.514 91.1676 161.514 94.7857C161.514 101.298 159.56 106.002 155.653 108.896C151.745 111.791 146.752 113.238 140.674 113.238H106.157ZM72.0742 50.5V205.5H147.186C154.133 205.5 160.899 204.632 167.484 202.895C174.069 201.158 179.93 198.481 185.068 194.863C190.206 191.245 194.294 186.577 197.333 180.861C200.373 175.144 201.892 168.378 201.892 160.563C201.892 150.866 199.54 142.581 194.837 135.707C190.133 128.832 183.006 124.02 173.454 121.27C180.401 117.942 185.647 113.672 189.193 108.462C192.738 103.252 194.511 96.7395 194.511 88.9244C194.511 81.6881 193.317 75.6097 190.929 70.6891C188.541 65.7684 185.176 61.8247 180.835 58.8578C176.493 55.891 171.283 53.7563 165.204 52.4538C159.126 51.1513 152.396 50.5 145.015 50.5H72.0742ZM106.157 179.015V136.466H143.279C150.66 136.466 156.593 138.167 161.08 141.568C165.566 144.969 167.81 150.649 167.81 158.609C167.81 162.662 167.122 165.99 165.747 168.595C164.372 171.2 162.527 173.263 160.211 174.782C157.896 176.302 155.218 177.387 152.179 178.039C149.14 178.69 145.956 179.015 142.627 179.015H106.157Z" fill="white" />
                                        </svg>
                                        </LazyLoad>
                                    </span>
                                    <h6 className=' text-white text-center'>BOOTSTRAP</h6>
                                </div>

                                <div className="skill mt-3">
                                    <span>
                                        <LazyLoad>
                                        <svg width="70" height="90" viewBox="0 0 256 384" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <h6 className=' text-white text-center'>FIGMA</h6>
                                </div>
